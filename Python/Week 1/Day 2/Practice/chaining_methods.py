...
print("----------------------------")
info.display_info().enroll().spend_points(50).display_info()


print("----------------------------")
info1.display_info().enroll().spend_points(80).display_info()

print("----------------------------")
info2.display_info().enroll().spend_points(201).display_info()
